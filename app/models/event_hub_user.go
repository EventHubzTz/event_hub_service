...
type EventHubUser struct {
	...
	Email         string `json:"email" gorm:"null;unique;size:50"`
	PhoneNumber   string `json:"phone_no" gorm:"not null;unique;size:20"`
	...
	Role          string `json:"role" gorm:"not null;type:enum('NORMAL_USER','EVENT_PLANNER','ACCOUNTANT','SUPER_ADMIN');default:'NORMAL_USER'"`
