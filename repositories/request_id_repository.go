...
func (_ eventHubRequestIDRepository) GetRequestID() (*models.EventHubRequestIDDTO, *gorm.DB) {
...
func (_ eventHubRequestIDRepository) GetMicroServiceExternalOperationsSetup(id uint64) (*models.EventHubExternalOperationsSetup, *gorm.DB) {
...
func (_ eventHubRequestIDRepository) UpdateSetupValue(id int, value string) *gorm.DB {
